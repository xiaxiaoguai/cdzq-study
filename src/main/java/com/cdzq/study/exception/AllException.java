...
public class AllException {
	...
	public void badRequestException(ValidationException e, HttpServletResponse response) {
		ResultData resultData = ResultData.error().message(e.getMessage());
		ResponseUtil.out(response, resultData);
	}
	//参数校验失败
	@ExceptionHandler(MethodArgumentNotValidException.class)
	public void badRequestException(MethodArgumentNotValidException e, HttpServletResponse response) {
