...
public class Des3 {
	...
	public static void main(String[] args) {
		...
		String key2 = "1002";
		String key3 = "1003";
		String systime = String.valueOf(Calendar.getInstance().getTimeInMillis()/1000L);
		String data = "CDZQKS,admin,系统管理员," + systime;
		System.out.println(data);
		String str = desObj.strEnc(data, key1, key2, key3);
		System.out.println(str);
		String dec = desObj.strDec("605239F166C8D4BE7BB938B7ADBB77AE", "a1", "a2", "a3");
	...
	public String strEnc(String data, String firstKey, String secondKey,
		...
		if (leng > 0) {
			if (leng < 4) {
				...
				int[] encByte = null;
				if (firstKey != null && !firstKey.equals("")
						&& !secondKey.equals("") && !secondKey.equals("")
						&& thirdKey != null && !thirdKey.equals("")) {
					int[] tempBt;
					int x;
					int y;
					int z;
					...
					if (firstKey != null && !firstKey.equals("")
							&& secondKey != null && !secondKey.equals("")) {
						int[] tempBt;
						int x;
						int y;
						tempBt = bt;
