...
public class FileUtil extends cn.hutool.core.io.FileUtil {
    ...
    public static String getRandomFileName(String filename) {
        ...
        generateRandStr = generateRandStr.append(str);
        Random rand = new Random();
        int randStrLength = 16;
        for (int i = str.length(); i < randStrLength; i++) {
            int randNum = rand.nextInt(10);
            generateRandStr.append(randStr.substring(randNum, randNum + 1));
        }
        String randomid = generateRandStr.toString();
        return randomid + "." +getExtensionName(filename);
    }
