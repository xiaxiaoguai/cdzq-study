...
public class IpUtils {
    ...
    public static void main(String[] args) {
        ...
        boolean flag = checkLoginIP("192.168.2.255", ipWhilte);
        boolean flag2 = checkLoginIP("192.168.1.2", ipWhilte);
        boolean flag3 = checkLoginIP("192.168.3.16", ipWhilte);
        boolean flag4 = checkLoginIP("192.167.5.16", ipWhilte);
        boolean flag5 = checkLoginIP("192.168.3.17", ipWhilte);
        System.out.println(flag); // true
        System.out.println(flag2); // false
        System.out.println(flag3); // false
        System.out.println(flag4); // true
        System.out.println(flag5); // true
        System.out.println("test::::"+ validate("10.23.9.*"));
        System.out.println("test::::"+ checkLoginIP("127.0.0.1", "10.23.-9.132"));
    }
}
